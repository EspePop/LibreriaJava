	...
	<head>
		...
		<script>
			function confirmar(event){
				window.confirm("¿Seguro que quieres eliminar este libro?");
			}
		</script>
	</head>
	<body>
		...
		<div class="container">			
			...
			<div class="row row-1">						
				<div class="form-style">
					<h4 class="col-md-12 h4">Eliminar libro</h4>
					<form action="servlet" method="post" onsubmit="confirmar(event)"  class="formulario col-md-12">
						<div class="form-group">
							<input type="text" name="codigo" placeholder="Introduce ID" class="form-control col-lg-12 col-md-12 col-sm-12"/>
					 	</div>
						<div class="form-group form-group-btn-enviar">
							<input type="hidden" name="op" value="3"/>
							<input type="submit" value="Eliminar" class="form_btn submit col-lg-6"/>	
						</div>
					</form>
				</div>				
			</div>
