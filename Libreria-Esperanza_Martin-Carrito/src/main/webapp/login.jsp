		...
		<div class="container">
        	<div class="row row-1">
                ...
                <div class="form-style">  
                	<h4 class="col-md-12 h4">LOGIN</h4>              
	                <form action="servlet" method="post" class="formulario col-md-12" id="login">
	                	<div class="form-group">
		                	<input type="text" class="form-control col-lg-12 col-md-12 col-sm-12" name="user" 
		                        id="user" title="Introduce nombre usuario" placeholder="Nombre Usuario" />
		                 </div>
		                 <div class="form-group">
		                	<input type="password" class="form-control col-lg-12 col-md-12 col-sm-12" name="pw" 
		                        id="pw" title="Introduce contraseña" placeholder="Contraseña" />
		                 </div>
						 <div class="form-group form-group-btn-enviar">
		                    <input type="hidden" name="op" value="9"/>
		                    <input type="submit" class="form_btn submit col-lg-6" value="login" id="login" title="Logarse"/>
		                 </div>					
					</form>	
				</div>	
			</div>			
